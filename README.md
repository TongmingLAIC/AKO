...
| **AKO4FIB** | Standardized harness built on [flashinfer-bench](https://github.com/flashinfer-ai/flashinfer-bench). Structured evaluation, NCU profiling, trajectory recording, and production integration. | [TongmingLAIC/AKO4FIB](https://github.com/TongmingLAIC/AKO4FIB) |
